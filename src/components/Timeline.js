...
const timelineData = [
  ...
  },
  {
    title: "POP",
    description:
      "Fexr is now available on the App Store and Google Play. Passport (Address) Oracles and Payments is focused.",
    date: "2022 Mar",
  },
];
      ...
      <div>
        <div className="container mx-auto flex flex-col items-start xl:flex-row">
          <div className="flex flex-col w-full sticky xl:top-36 xl:w-1/3 mt-2 xl:mt-12 px-8">
            <p className="ml-2 font-black dark:font-normal text-orange-500 dark:text-yellow-300 uppercase tracking-loose" />
            <p className="text-3xl md:text-4xl leading-normal md:leading-relaxed mb-2">
              Working Process of Fexr
            </p>
            <p className="text-sm md:text-base dark:text-gray-50 mb-4">
              Here’s your guide to the development progress of Fexr. We are
              working hard to make Fexr the best Web3 payments platform for you.
            </p>
            <a
                ...
                {timelineData.map((data, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <p className="mb-3 text-base font-black dark:font-normal text-orange-500 dark:text-yellow-300">
                          {data.date}
                        </p>

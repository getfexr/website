...
Let's discover what **Fexr** can do for you.

:::success

[You can now use strong NLSS (Non Linear Secret Sharing) signing and validation in your app for authentication and verifcation of users and their content.](/docs/auth/setup)
